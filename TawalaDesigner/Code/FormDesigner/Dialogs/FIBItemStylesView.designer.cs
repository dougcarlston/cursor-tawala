...
{
	partial class FibItemStylesView
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.labelApplyOptions.Text = "You may apply the Style to the selected Fill in the Blank questions in the active" +
				" form, or to all Fill in the Blank questions in the project.";
			// 
			// buttonApplySelected
			// 
