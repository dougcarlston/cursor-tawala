...
{
	partial class TextItemStylesView
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.panelText.Size = new System.Drawing.Size(443, 199);
			...
			this.panelButtons.Location = new System.Drawing.Point(0, 199);
			...
			this.labelApplyOptions.Text = "You may apply the style to the selected Text items in the active form, or to all " +
				"Text items in the project.";
			// 
			// buttonApplySelected
			// 
