...
namespace TawalaTest.FormDesignerTest.Browser.Selection
{
	...
	public class FontSizeTest : TestBase
	{
		...
		public void SetWhenSelectionWithinNestedSizes()
		{
			...
			string expectedHtml = @"<P style=""MARGIN-LEFT: 0pt"" align=left><SPAN style=""FONT-SIZE: 20pt""><SPAN style=""FONT-SIZE: 24pt""><SPAN style=""FONT-SIZE: 16pt"">On</SPAN>e </SPAN>Two</SPAN></P>";
		...
		public void SettingWordSizeAfterSettingParagraphSizeProducesExpectedHtml()
		{
			...
			string expectedHtml = @"<P style=""MARGIN-LEFT: 0pt"" align=left><SPAN style=""FONT-SIZE: 16pt"">One&nbsp;<SPAN style=""FONT-SIZE: 24pt"">Two</SPAN> Three</SPAN></P>";
		...
		public void SettingWordSizeAfterSettingPhraseSizeProducesExpectedHtml()
		{
			...
			string expectedHtml = @"<P style=""MARGIN-LEFT: 0pt"" align=left>One&nbsp;<SPAN style=""FONT-SIZE: 16pt"">Two&nbsp;<SPAN style=""FONT-SIZE: 24pt"">Three</SPAN> Four</SPAN> Five</P>";
		...
		public void SettingWordSizeAfterSettingParagraphColorProducesExpectedHtml()
		{
			...
			string expectedHtml = @"<P style=""MARGIN-LEFT: 0pt"" align=left><SPAN style=""COLOR: #ff0000"">One&nbsp;<SPAN style=""FONT-SIZE: 24pt"">Two</SPAN> Three</SPAN></P>";
		...
		public void SettingWordSizeAfterSettingParagraphFaceProducesExpectedHtml()
		{
			...
			string expectedHtml = @"<P style=""MARGIN-LEFT: 0pt"" align=left><SPAN style=""FONT-FAMILY: Courier New"">One&nbsp;<SPAN style=""FONT-SIZE: 24pt"">Two</SPAN> Three</SPAN></P>";
		...
		public void SettingWordSizeAfterSettingPhraseColorProducesExpectedHtml()
		{
			...
			string expectedHtml = @"<P style=""MARGIN-LEFT: 0pt"" align=left>One&nbsp;<SPAN style=""COLOR: #ff0000"">Two&nbsp;<SPAN style=""FONT-SIZE: 24pt"">Three</SPAN> Four</SPAN> Five</P>";
		...
		public void SettingWordSizeAfterSettingPhraseFaceProducesExpectedHtml()
		{
			...
			string expectedHtml = @"<P style=""MARGIN-LEFT: 0pt"" align=left>One&nbsp;<SPAN style=""FONT-FAMILY: Courier New"">Two&nbsp;<SPAN style=""FONT-SIZE: 24pt"">Three</SPAN> Four</SPAN> Five</P>";
