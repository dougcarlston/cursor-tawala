...
namespace Tawala.Common
{
    ...
    public static class Config
    {
        ...
        public static RuntimeType RuntimeEnvironment { get { return runtimeEnvironment; } }
        ...
        public static string InvitationsFile { get { return Path.Combine(DefaultProjectDirectory, "Invitations"); } }

        public static string ClientURL { get { return clientURL; } }

        public static string FunctionRepositoryURL { get { return RootURL + "display-component-repository"; } }

        public static string FunctionRepositoryVersionURL { get { return RootURL + "display-component-repository-version"; } }

        public static string RootURL { get { return Regex.Match(clientURL, "[^:]*://[^/]*/").Value; } }

        public static string ProjectManagerURL { get { return projectManagerURL; } }

        public static string Build { get { return build; } }

        public static string BuildName { get { return buildName; } }
        public static string ThemesURL { get { return RootURL + "projectThemes"; } }

        public static string LocalApplicationData
        {
            get
            {
                createLocalApplicationData();
                return localAppData;
            }
        }
            ...
            get
            {
                if (temporaryFiles == null)
                {
                    try
                    {
                        ...
                        createDirectory(temporaryFiles);
                    }
                    catch (Exception)
                    {
                    }
        ...
        private static void createLocalApplicationData()
        {
            try
            {
