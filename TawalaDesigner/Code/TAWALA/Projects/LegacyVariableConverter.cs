    ...
    public static class LegacyVariableConverter
    {
        ...
        public static Stream Convert(Stream inputXmlStream)
        {
            ...
            if (projectXmlIsPreHiddenField())
            {
                ...
                var outputXmlStream = new MemoryStream();
        ...
        private static void addSetHiddenFieldElementsToProcess(ISetElement setElements, string formName)
        {
            foreach (ISetElement setElement in setElements.RecursiveEnumerator)
            {
                ...
                {
                    XmlElement duplicateStatementElement = convertSetStatementToSetHiddenFieldStatement(formName, setElement,
                                                                                                        statementElement);
        ...
        /// </summary>
        private static XmlElement convertSetStatementToSetHiddenFieldStatement(string formName, ISetElement setElement,
                                                                               XmlElement statementElement)
        {
            var duplicateStatementElement = (XmlElement)statementElement.Clone();
        ...
        {
            var formElements = new Collection<XmlElement>();
            ...
            foreach (XmlNode componentNode in xmlDocument.DocumentElement.ChildNodes)
            {
                ...
                if (componentElement != null)
                {
                    if (componentElement.Name == "forms")
                    {
                        ...
                        {
                            var formElement = formNode as XmlElement;
            ...
            foreach (XmlNode componentNode in xmlDocument.DocumentElement.ChildNodes)
            {
                ...
                if (componentElement != null)
                {
                    if (componentElement.Name == "processes")
                    {
                        ...
                        {
                            var processElement = processNode as XmlElement;
        ...
        {
            var setElements = new SetElementCollection();
        ...
        #region Nested type: ISetElement

        private interface ISetElement : IRecursiveEnumerable
        {
        ...
        #region Nested type: SetElement

        private class SetElement : ISetElement
        {
            private readonly XmlElement containerElement;
            ...
            public XmlElement ContainerElement { get { return containerElement; } }

            public XmlElement Element { get { return element; } }

            public string FieldName { get { return element.GetAttribute("field"); } }
        ...
        #region Nested type: SetElementCollection
        ...
        private class SetElementCollection : Collection<ISetElement>, ISetElement
        {
            ...
            public XmlElement ContainerElement { get { return null; } }

            public XmlElement Element { get { return null; } }
