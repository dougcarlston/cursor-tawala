...
namespace Tawala.Projects
{
    ...
    {
        private readonly IProjectComponent component;

        public ComponentEventArgs(IProjectComponent comp)
        {
            component = comp;
        }

        public IProjectComponent Component { get { return component; } }
    }
    ...
    {
        public ComponentCancelEventArgs(IProjectComponent comp) : base(comp)
        {
        }
    ...
    {
        private readonly int processLineIndex;
        private readonly ProcessStatement statement;
        ...
        public int ProcessLineIndex { get { return processLineIndex; } }

        public ProcessStatement Statement { get { return statement; } }
    }

    public class MCItemEventArgs : EventArgs
    {
        private readonly IMcqItem[] items;

        public MCItemEventArgs()
        {
            items = new IMcqItem[] {null};
        }
        ...
        public IMcqItem[] Items { get { return items; } }
    }
    ...
    public class ComponentRenamedEventArgs : ComponentEventArgs
    {
        ...
        public ComponentRenamedEventArgs(IProjectComponent comp, string oldname) : base(comp)
        {
            oldName = oldname;
        }
    ...
    public class FormItemEventArgs : EventArgs
    {
        ...
        private readonly IFormItem item;
        ...
        public IFormItem Item { get { return item; } }
    ...
    {
        private readonly string newProjectName;
        ...
        public string OldProjectName { get { return oldProjectName; } }

        public string NewProjectName { get { return newProjectName; } }
    }

    public class StatementEventArgs : EventArgs
    {
        private readonly Process process = Process.NULL;
        private readonly ProcessStatement statement;
    ...
    {
        private readonly IForm connectedForm;
        private readonly IProcess connectedProcess;
        ...
        public IProcess ConnectedProcess { get { return connectedProcess; } }

        public IForm ConnectedForm { get { return connectedForm; } }
    }
