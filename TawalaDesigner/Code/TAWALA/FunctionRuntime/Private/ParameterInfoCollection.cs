...
{
    public sealed class ParameterInfoCollection : Collection<IParameterInfo>, IParameterInfoCollection
    {
        private readonly Dictionary<string, IParameterInfo> idToInfo = new Dictionary<string, IParameterInfo>();

        public ParameterInfoCollection(IFunctionInfo functionInfo, IParameterInfo parameterInfo, Type enclosingType)
        {
            BindingFlags bindingFlags = BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly;
            PropertyInfo[] properties = enclosingType.GetProperties(bindingFlags);
        ...
        public IParameterInfo this[string id]
        {
            get
            {
                return idToInfo[id];
        ...
        protected override void InsertItem(int index, IParameterInfo item)
        {
