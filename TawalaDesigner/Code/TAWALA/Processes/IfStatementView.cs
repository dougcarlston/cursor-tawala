...
namespace Tawala.Processes
{
    public partial class IfStatementView : IfStatementViewBase
    {
        ...
        public IfStatementView()
        {
            ...
            labelIf2.Text = Resources.SingleIfCondition;
            comboBoxAndOr.Visible = false;

            comboBoxAndOr.VisibleChanged += comboBoxAndOr_VisibleChanged;

            groupBox.ControlAdded += panel1_ControlAdded;
            groupBox.ControlRemoved += panel1_ControlRemoved;
            groupBox.Layout += groupBox_Layout;
        ...
        private void comboBoxAndOr_VisibleChanged(object sender, EventArgs e)
        {
            ...
            {
                labelIf2.Text = Resources.MultipleIfConditions;
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            conditionGroupHeight = (groupBox.Controls[0]).Height;
        ...
        {
            return ((groupBox.Controls[groupBox.Controls.Count - 1]).Bottom + conditionGroupHeight >= checkBoxOtherwise.Top);
        }
        ...
        public override void ParentWindowClosed()
        {
            Project.Events.RaiseMCItemSelectedEvent(new MCItemEventArgs());
        }
