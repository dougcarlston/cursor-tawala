// $Workfile: CommentStatementView.Designer.cs $
// $Revision: 1 $	$Date: 1/08/07 6:12p $
// Copyright © 2005 Tawala Systems, Inc. All rights reserved.
namespace Tawala.Processes
{
	partial class CommentStatementView
	{
        /// <summary> 
        ...
        private void InitializeComponent()
		{
			...
			// tabPageSet
			// 
			this.tabPageSet.Controls.Add(this.textBoxComment);
			...
			this.textBoxComment.Location = new System.Drawing.Point(8, 8);
			this.textBoxComment.Name = "textBoxComment";
			this.textBoxComment.Size = new System.Drawing.Size(397, 20);
			this.textBoxComment.TabIndex = 0;
			// 
			// CommentDetails
			// 
			this.Controls.Add(this.tabControl);
			this.Name = "CommentStatementView";
