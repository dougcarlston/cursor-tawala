...
{
    [TestFixture]
    public class RecordQualfiedParametersTest2056 : FunctionTest
    {
        ...
        private IFunction makeListFunction()
        {
            ...
            var functionBlank = new FunctionBlank(field);
        ...
        private IFunction makeChoiceTallyTableFunction()
        {
            ...
            var functionMCItem = new FunctionMCItem(field);
        ...
        {
            string xmlString = "<simple-list version=\"2\">" + "<simple-list-field>Record:Form 1:Q1:a</simple-list-field>" +
                               "<conditions></conditions>" + "</simple-list>";
        ...
        {
            string xmlString = "<choice-tally-table version=\"1\">" + "<field>Record:Form 1:Q3</field>" + "<conditions>" + "</conditions>" +
                               "</choice-tally-table>";
        ...
        public void SettingBlankInParameterGeneratesRecordFieldInPersistenceXml()
        {
            ...
            string expectedXml = "<simple-list version=\"2\">" + "<simple-list-field>Record:Form 1:Q1:a</simple-list-field>" +
                                 "<conditions></conditions>" + "</simple-list>";
        ...
        public void SettingMCItemInParameterGeneratesRecordFieldInPersistenceXml()
        {
            ...
            string expectedXml = "<choice-tally-table version=\"1\">" + "<field>Record:Form 1:Q3</field>" + "<conditions>" + "</conditions>" +
                                 "</choice-tally-table>";
