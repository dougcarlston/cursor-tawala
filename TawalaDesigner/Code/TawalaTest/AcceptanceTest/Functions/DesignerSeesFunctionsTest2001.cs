...
{
    /// <summary>
    /// Acceptance tests for story 2001 (Designer sees available Functions).
    /// </summary>
    [TestFixture]
    public class DesignerSeesFunctionsTest2001 : FunctionTest
    {
        ...
        {
            Expect.Once.On(mockView).Method("Setup").With(functionRepository.Categories);
