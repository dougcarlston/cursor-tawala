...
{
    [TestFixture]
    public class UndoCutGroupTest2598
    {
        ...
        [Test]
        public void CanCutInnerStatementGroupFromProcess()
        {
            int i = 0;
        ...
        [Test]
        public void CanCutOuterStatementGroupFromProcess()
        {
            int i = 0;
            Assert.AreEqual("Get record list from Form 1", process.Lines[i++].ToString());
            Assert.AreEqual("For Each record in record list", process.Lines[i++].ToString());
        ...
        [Test]
        public void InnerCutCanBeRedone()
        {
            processEditor.SelectedLineIndex = 3;
            processEditor.Cut();
            processEditor.Undo();
        ...
        [Test]
        public void InnerCutCanBeUndone()
        {
            processEditor.SelectedLineIndex = 3;
            processEditor.Cut();
            processEditor.Undo();
        ...
        [Test]
        public void OuterCutCanBeRedone()
        {
            processEditor.SelectedLineIndex = 1;
            processEditor.Cut();
            processEditor.Undo();
        ...
        [Test]
        public void OuterCutCanBeUndone()
        {
            processEditor.SelectedLineIndex = 1;
            processEditor.Cut();
            processEditor.Undo();
