...
namespace Tawala.Functions.Runtime.CodeGen
{
    internal sealed class ParameterPropertyCreator : Creator
    {
        ...
        public void Create(StringBuilder sbAppendTo)
        {
            ...
            controlName = FunctionParameterTypeMapper.GetControlTypeFromXmlType(xmltype);
        ...
        {
            sbProperty = new StringBuilder(Resources.PARAMETER_PROPERTY_TEMPLATE);
            sbProperty.Replace("${TYPE}", typeName).Replace("${GID}", navParameter.GetAttribute("gid", ""))
        ...
        {
            sbProperty = new StringBuilder(Resources.COMPOSITE_PROPERTY_TEMPLATE);
            sbProperty.Replace("${FNAME}", fieldName).Replace("${GID}", navParameter.GetAttribute("gid", ""))
                .Replace("${PNAME}", propName)
                .Replace("${CCID}", id);
