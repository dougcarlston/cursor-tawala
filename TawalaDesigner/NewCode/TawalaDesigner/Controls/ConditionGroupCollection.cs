...
namespace Tawala.Controls
{
    public class ConditionGroupCollection
    {
                    ...
                    for (int i = 0; i < container.Controls.Count; i++)
                    {
                        ...
                        if (field != null)
                        {
                            ...
                            if (!isLastGroup(i))
                            {
                                ...
                                if (nextField != null)
                                {
                                    conditions.Add(comboBoxAndOr.SelectedIndex == 0
                ...
                else
                {
                    foreach (IConditionComponent component in value)
                    {
                        if (component is Condition)
                        {
                            ...
                            string expressionString = (condition.Expression == null)
                                                          ? ""
        ...
        private void setLogicalOperatorLabels()
        {
            ...
            //for (int i = 2; i < container.Controls.Count; i++)
            //{
            //    ConditionGroup group = container.Controls[i] as ConditionGroup;
            //    group.LabelAndOr.Text = text;
            //}
        }
