...
namespace TawalaTest.FormDesignerTest.StoryTest
{
    ...
    public class FunctionInTextItem2672 : FunctionTestBase
    {
        ...
        {
            IFunction function = createSumFunction();
        ...
        {
            string projectXml =
				@"<project name=""Sum-FormBlank"" themePath=""default"" format=""" + Project.XmlFormatVersion + @""" designerBuild=""0"">" + Environment.NewLine +
                ...
                @"Underscores create blanks.] <blank label=""a"" length=""20"" height=""1"" required=""false""/></paragraph></fib>" +
                Environment.NewLine +
                ...
                @"add choices below.]</font></paragraph></question><choice label=""a""></choice></mc>" +
                Environment.NewLine +
        ...
        {
            string projectXml =
                @"<project name=""test"" themePath=""default"" format=""" + Project.XmlFormatVersion + @""" designerBuild=""0"">" +
                Environment.NewLine +
				@"<pageHeader></pageHeader>" +
				@"<forms>" + Environment.NewLine +
                @"<form name=""Form 1"" startPoint=""true""><items>" + Environment.NewLine +
        ...
        {
            string projectXml =
                @"<project name=""Sum-FormBlank"" themePath=""default"" format=""" + Project.XmlFormatVersion + @""" designerBuild=""0"">" +
                Environment.NewLine +
				@"<pageHeader></pageHeader>" +
				@"<forms>" + Environment.NewLine +
                @"<form name=""Form 1"" startPoint=""true""><items>" + Environment.NewLine +
            ...
            var fibItem = Project.Current.FormList[0].ItemList[0] as IFibItem;
            IBlank blank = fibItem.BlankList[0];
            var mcqItem = Project.Current.FormList[0].ItemList[1] as IMcqItem;
            var hiddenField = Project.Current.FormList[0].ItemList[2] as IHiddenField;
        ...
        public void FunctionWithBlankParameterGeneratesCorrectXml()
        {
            ...
            IFunction functionSum = createSumFunction(FunctionBlank.Parse(blank), form);
        ...
        public void InsertedFunctionWithBlankParameterGeneratesCorrectTextItemXml()
        {
            ...
            var fibItem = form.ItemList[1] as IFibItem;
            IBlank blank = fibItem.BlankList[0];
        ...
        public void InsertedFunctionWithHiddenFieldParameterGeneratesCorrectXml()
        {
            ...
            IFunction functionSum = createSumFunction(FunctionBlank.Parse(hiddenField), form);
        ...
        public void InsertedFunctionWithMcqParameterGeneratesCorrectXml()
        {
            ...
            var mcqItem = form.ItemList[1] as IMcqItem;
