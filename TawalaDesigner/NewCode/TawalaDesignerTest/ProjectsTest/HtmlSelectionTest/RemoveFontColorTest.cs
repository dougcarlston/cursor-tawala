...
{
    [TestFixture]
    public class RemoveFontColorTest
    {
        ...
        [Test]
        public void CanRemoveFontColorOnSelectionBridgingTwoParagraphsWithExistingAttributesInOne()
        {
            const string htmlText =
                @"<P style=""MARGIN-LEFT: 0pt"" align=left><SPAN style=""COLOR: #FF0000;"">Paragraph One</SPAN></P>" +
        ...
        {
            const string htmlText = @"<SPAN style=""COLOR: #FF0000;"">Selection</SPAN>";
