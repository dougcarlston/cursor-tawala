...
namespace TawalaTest.ProjectTest
{
	...
	public class SkipInstructionsTest
	{
		...
		{
			ISkipInstructions instructions = new NewSkipInstructions();
		...
		public void GetXml()
		{
			...
			SkipToDestinationItem label = new SkipToDestinationItem(((IMcqItem)form.ItemList[0]));
		...
		public void CanConstructSimpleSkipInstructionsFromIXmlElement()
		{
			...
			ISkipInstructions skipInstructions = new NewSkipInstructions(new XmlElement(xmlString));
