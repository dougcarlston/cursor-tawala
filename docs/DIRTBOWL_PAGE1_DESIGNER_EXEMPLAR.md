...
| **Insert presets: Date + Address** | **Parked (Sep 2026)** — `fibInsertPresets.ts` + Sign-up template; **Insert menu hidden** until Design/Preview/Push share label-column geometry. Re-enable together. |
