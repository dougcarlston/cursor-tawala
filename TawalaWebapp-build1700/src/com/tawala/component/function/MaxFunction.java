...
/** Max of numeric blank/hidden field values across matching records (SUM family). */
public class MaxFunction extends FunctionMetadataSupport {
	private static final String COMPONENT_ID = "max";
