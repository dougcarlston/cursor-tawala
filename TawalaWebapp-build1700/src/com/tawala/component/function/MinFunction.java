...
/** Min of numeric blank/hidden field values across matching records (SUM family). */
public class MinFunction extends FunctionMetadataSupport {
	private static final String COMPONENT_ID = "min";
