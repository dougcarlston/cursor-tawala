...
public class HandleInvoiceWaitTimeout implements ActionHandler {
		...
		Log
				.error(
						...
						"Project '"
								...
								+ " has been moved into the exception handling stage because the invoice hasn't been received.");
