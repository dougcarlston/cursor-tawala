 ...
 * Use localhost — same origin as owner review tabs. 127.0.0.1 ≠ localhost for localStorage,
 * so Show in My Tawala on 127.0.0.1 would miss projects acquired on localhost. */
