// $Workfile: Expression.cs $
// $Revision: 46 $	$Date: 3/14/08 8:33a $
...
namespace Tawala.Projects
{
	...
	public class Expression
	{
		...
		/// </summary>
		public Boolean HasSingleFieldElement
		{
			get
			{
				return (HasFieldElement && (elements.Count == 1));
			}
		}
		...
		/// </summary>
		public Boolean HasSingleChoiceField
		{
			get
			{
				return (HasSingleFieldElement && ((FieldElement)elements[0]).Field is ChoiceField);
			}
		}
		...
		/// </summary>
		public Boolean HasSingleStringElement
		{
			get
			{
				return (HasStringElement && (elements.Count == 1));
			}
		}
		...
		public virtual string ToXml()
		{
			...
			if (ToString().Length > 0)
			{
				...
				if (isArithmetic())
				{
					...
					MathParser parser = new MathParser(ToString());
	...
	public class RationalFieldExpression : Expression
	{
		...
		public RationalFieldExpression(IXmlElement element, IField fieldResolver) : base("<<" + element.GetAttribute("name") + ">>", fieldResolver)
		{
		}
	}
	...
	public class ArithmeticExpression : Expression
	{
		...
		/// </summary>
		public ArithmeticExpression(IXmlElement element, IField fieldResolver) : base()
		{
		...
		public ArithmeticExpression(IXmlElement element, Process process) : base()
		{
	...
	public class CompoundExpression : Expression
	{
		...
		public CompoundExpression(IXmlElement element, Process process) : base()
		{
			StringBuilder sb = new StringBuilder();
		...
		public CompoundExpression(IXmlElement element, IField fieldResolver) : base()
		{
			StringBuilder sb = new StringBuilder();
