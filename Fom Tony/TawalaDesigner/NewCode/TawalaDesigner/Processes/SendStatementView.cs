...
namespace Tawala.Processes
{
    ...
    public partial class SendStatementView : SendStatementViewBase
	{
		...
		protected override void NewStatement()
		{
			...
			statement.SendBody = new SendDocumentBody(NullObjects.Document);
		}

		protected override void OnEdit()
		{
			//ParentView.SplitContainer.SplitterDistance = 208;
			...
			{
				textBoxEmailRecipient.Tag = Project.FieldMapById.FindField(statement.AddressTo.Text);
			}
