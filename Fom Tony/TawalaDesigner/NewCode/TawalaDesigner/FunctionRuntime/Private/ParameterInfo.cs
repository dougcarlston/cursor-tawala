...
namespace Tawala.Functions.Runtime.Private
{
    internal sealed class ParameterInfo : IParameterInfo
    {
        ...
        public IParameterInfo Parent { get { return parentParameter; } }

        public IParameterInfoCollection Parameters { get { return children; } }

        public string Id { get { return navParam.GetAttribute("id", ""); } }

        public string Name { get { return navParam.GetAttribute("name", ""); } }

        public string Description { get { return navParam.SelectSingleNode("child::description").Value; } }
        ...
        public IFunctionInfo FunctionInfo { get { return functionInfo; } }
        ...
        public IFunctionParameterTypeInfo MapInfo { get { return FunctionParameterTypeMapper.Map[navParam.GetAttribute("type", "")]; } }

        public ParameterRestrictions Restrictions { get { return restrictions; } }

        public string RecordListName { get { return recordListName; } }

        /// <summary>The parameter's xml definition stripped of namespaces</summary>
        public XPathNavigator Xml { get { return navParam.Clone(); } }
        ...
        internal ParameterInfo(IFunctionInfo fInfo, IParameterInfo pInfo, PropertyInfo pi, ParameterPropertyAttribute attr)
        {
            ...
            navParam = fa.FindByGid(parameterPropertyAttribute.Gid);
        ...
        private bool hasValidValue(IFunction instance)
        {
            ...
            if (isComposite)
            {
                return validateAutoComposite(o as ICompositeParameter, instance);
            }

            if (isCompositeCollection)
            {
                return validateAutoCompositeCollection(o as ICompositeParameterCollection, instance);
            }

            return false;
        }

        private bool validateAutoCompositeCollection(ICompositeParameterCollection collection, IFunction instance)
        {
            foreach (ICompositeParameter composite in collection)
            {
                if (!validateAutoComposite(composite, instance))
                {
                    return false;
                }
            }
        ...
        private bool validateAutoComposite(ICompositeParameter composite, IFunction instance)
        {
            if (composite == null)
            {
                return false;
            ...
            foreach (IParameterInfo subParam in Parameters)
            {
                ...
                {
                    PropertyInfo pi = composite.GetType().GetProperty(subParam.PropertyName);
