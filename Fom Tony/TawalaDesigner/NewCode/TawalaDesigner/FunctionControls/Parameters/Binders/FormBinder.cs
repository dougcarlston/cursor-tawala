...
{
    public class FormBinder : ParameterBinder
    {
        private readonly FormBindingList formBindingList;

        protected FormBinder(IFunction instance, IParameterInfo info)
            : base(instance, info)
        {
        ...
        {
            public FormBindingList() : base(Project.Current.AllForms)
            {
