...
namespace Tawala.ProjectExplorer.Dialogs
{
    ...
    {
        private const string mailToFormat = "mailto:{0}?subject={1}&body={2}";
        private const string subjectFormat = "Tawala Project file error: {0}";
        private const string tawalaContactList = "jdf@tawala.com; johns@tawala.com";
