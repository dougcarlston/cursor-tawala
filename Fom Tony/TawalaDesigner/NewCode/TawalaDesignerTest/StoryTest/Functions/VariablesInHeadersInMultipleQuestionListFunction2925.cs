...
{
    [TestFixture]
    public class VariablesInHeadersInMultipleQuestionListFunction2925 : FunctionTestBase
    {
        ...
        private static readonly string multipleQuestionListFunctionXmlWithVariableInColumnHeader =
            "<itemization-table version=\"2\">" +
            "<number-of-columns>1</number-of-columns>" +
            "<column>" +
            "<header><field name=\"Score\"/>" + Environment.NewLine + "<string value=\" Address\"/>" +
        ...
        public void ItemizationTableFunctionWithVariableInColumnHeaderProducesExpectedXml()
        {
            ...
            IFunction function =
                converter.ConvertFrom(new XmlElement(multipleQuestionListFunctionXmlWithVariableInColumnHeader));
            ...
            Assert.AreEqual(multipleQuestionListFunctionXmlWithVariableInColumnHeader, function.ToXml(),
