...
namespace TawalaTest.FormDesignerTest.Browser.Selection
{
    ...
    public class FontColorTest : TestBase
    {
        ...
        public void SettingWordColorAfterSettingParagraphColorProducesExpectedHtml()
        {
            ...
            string expectedHtml =
                @"<P style=""MARGIN-LEFT: 0pt"" align=left><SPAN style=""COLOR: #00ff00"">One&nbsp;<SPAN style=""COLOR: #ff0000"">Two</SPAN> Three</SPAN></P>";
        ...
        public void SettingWordColorAfterSettingParagraphFaceProducesExpectedHtml()
        {
            ...
            string expectedHtml =
                @"<P style=""MARGIN-LEFT: 0pt"" align=left><SPAN style=""FONT-FAMILY: Courier New"">One&nbsp;<SPAN style=""COLOR: #ff0000"">Two</SPAN> Three</SPAN></P>";
        ...
        public void SettingWordColorAfterSettingParagraphSizeProducesExpectedHtml()
        {
            ...
            string expectedHtml =
                @"<P style=""MARGIN-LEFT: 0pt"" align=left><SPAN style=""FONT-SIZE: 24pt"">One&nbsp;<SPAN style=""COLOR: #ff0000"">Two</SPAN> Three</SPAN></P>";
        ...
        public void SettingWordColorAfterSettingPhraseColorProducesExpectedHtml()
        {
            ...
            string expectedHtml =
                @"<P style=""MARGIN-LEFT: 0pt"" align=left>One&nbsp;<SPAN style=""COLOR: #00ff00"">Two&nbsp;<SPAN style=""COLOR: #ff0000"">Three</SPAN> Four</SPAN> Five</P>";
        ...
        public void SettingWordColorAfterSettingPhraseFaceProducesExpectedHtml()
        {
            ...
            string expectedHtml =
                @"<P style=""MARGIN-LEFT: 0pt"" align=left>One&nbsp;<SPAN style=""FONT-FAMILY: Courier New"">Two&nbsp;<SPAN style=""COLOR: #ff0000"">Three</SPAN> Four</SPAN> Five</P>";
        ...
        public void SettingWordColorAfterSettingPhraseSizeProducesExpectedHtml()
        {
            ...
            string expectedHtml =
                @"<P style=""MARGIN-LEFT: 0pt"" align=left>One&nbsp;<SPAN style=""FONT-SIZE: 24pt"">Two&nbsp;<SPAN style=""COLOR: #ff0000"">Three</SPAN> Four</SPAN> Five</P>";
