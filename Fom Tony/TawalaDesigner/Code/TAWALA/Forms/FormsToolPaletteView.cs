...
{
    public partial class FormsToolPaletteView : UserControl
    {
        ...
        #region Nested type: FormItemLabel

        internal class FormItemLabel : Label
        {
            public override bool AutoSize { get { return false; } set { base.AutoSize = false; } }

            public override Size MinimumSize { get { return new Size(0, 28); } set { base.MinimumSize = new Size(0, 28); } }

            public override Size MaximumSize { get { return new Size(0, 28); } set { base.MaximumSize = new Size(0, 28); } }
        }
