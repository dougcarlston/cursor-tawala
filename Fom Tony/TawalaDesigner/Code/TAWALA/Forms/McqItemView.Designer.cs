// $Workfile: McqItemView.Designer.cs $
// $Revision: 5 $	$Date: 10/17/06 3:25p $
// Copyright © 2005 Tawala Systems, Inc. All rights reserved.
namespace Tawala.Forms
{
	internal partial class McqItemView
	{
		/// <summary> 
		...
		{
			this.itemTextEditor = new McqItemTextEditor();
			this.SuspendLayout();
			// 
			// itemTextEditor
			// 
			...
			this.itemTextEditor.Size = new System.Drawing.Size(352, 128);
			this.itemTextEditor.TabIndex = 0;
			this.itemTextEditor.Text = "";
			this.itemTextEditor.TextChanged += new System.EventHandler(this.itemTextEditor_Changed);
			// 
			// McqItemView
			// 
		...
		private McqItemTextEditor itemTextEditor;
	}
}
