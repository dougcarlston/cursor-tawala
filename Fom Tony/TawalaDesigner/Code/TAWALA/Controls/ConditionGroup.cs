...
namespace Tawala.Controls
{
    ...
    public partial class ConditionGroup : UserControl
    {
        ...
        protected override void OnLayout(LayoutEventArgs e)
        {
            ...
            int width = (ClientSize.Width - 33 - buttonPlus.Width - buttonMinus.Width)/3;

            textBoxField.Width = width;
            comboBoxOperator.Width = width;
        ...
        private bool expressionBoxContainsField()
        {
            ...
            return expression != null && expression.Elements.Count > 0 && expression.Elements[0] is FieldElement;
        }
