...
namespace Tawala.Controls
{
    ...
    public partial class ConditionEditControl : UserControl
    {
        ...
        protected override void OnLayout(LayoutEventArgs e)
        {
            ...
            MinimumSize = new Size(Width, 27);
            Size = MinimumSize;

            int width = Size.Width;
           
            width -= buttonPlus.Width + buttonPlus.Margin.Horizontal;
            width -= buttonMinus.Width;
            width -= comboBoxOperator.Width + comboBoxOperator.Margin.Horizontal;
            width = width/2;
            Size size = new Size(width, textBoxField.Height);
            textBoxField.Size = textBoxField.MinimumSize = textBoxField.MaximumSize = size;
            textBoxExpression.Size = textBoxExpression.MinimumSize = textBoxExpression.MaximumSize = size;
