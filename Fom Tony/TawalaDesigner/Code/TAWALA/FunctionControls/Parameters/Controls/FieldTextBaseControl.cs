...
{
    [ToolboxItem(false)]
    public abstract class FieldTextBaseControl<T> : TextBox, IParameterControl, IPaletteFieldAccepted 
        where T : FunctionFieldWrapper, IFunctionParameterValue
    {
        ...
        protected FieldTextBaseControl()
        {
            ReadOnly = true;
        ...
        public abstract bool IsAcceptedData(IPaletteField field);
        public abstract void AcceptData(IPaletteField field);
