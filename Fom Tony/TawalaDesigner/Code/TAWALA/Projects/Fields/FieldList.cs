...
namespace Tawala.Projects.Fields
{
    ...
    {
        private static int nextFieldListId;
        public static FieldList NULL = new FieldList();
        private readonly SortedList fieldsByName = new SortedList();
        ...
        public void AddUnique(IField field)
        {
            ...
            {
                foreach (IField item in RecursiveEnumerator)
                {
                    if (f.Id == item.Id)
                    {
                        return;
        ...
        private void addToFieldsByName(IField field)
        {
            if (field is IPaletteField)
            {
                ...
                fieldsByName[(field).QualifiedFieldName] = field;
            }
        ...
        private readonly int fieldListId;

        public string FieldName { get { return "Unnamed FieldList " + fieldListId; } }
