...
namespace Tawala.Common
{
	...
	{
		static private readonly string settingsDirectoryName = "Tawala";
		...
		static GlobalSettings()
		{
			...
			try
			{
				...
				settingsDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), settingsDirectoryName);
