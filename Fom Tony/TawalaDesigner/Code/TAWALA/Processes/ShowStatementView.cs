...
namespace Tawala.Processes
{
    public partial class ShowStatementView : ShowStatementViewBase
    {
        ...
        private readonly BindingSource documentBinder = new BindingSource();
        private readonly BindingSource formBinder = new BindingSource();
        private readonly BindingSource recordBinder = new BindingSource();

        private int conditionGroupHeight;
        private ConditionGroupCollection groups;
        private int lastDocTabPageWidth;
        private int lastFormTabPageWidth;
        private int lastUrlTabPageWidth;
        private ShowRecordStatement scratchStatement;
        ...
        private ShowRecordStatement showRecordStatement;
        ...
        private void groupBoxWhere_ControlAdded(object sender, ControlEventArgs e)
        {
            ...
            group.TextBoxField.Enter += textBoxField_Enter;
            group.TextBoxExpression.Enter += textBoxExpression_Enter;
        ...
        private void Events_DocumentOrFormChanged(object sender, ComponentEventArgs e)
        {
...
//				setDetailsPanelHeight(recordDetailsPanelHeight);
        ...
        protected override void OnEdit()
        {
            ...
            if (statement is ShowDocumentStatement)
            {
                ...
                {
                    documentBinder.Position =
                        documentBinder.IndexOf(Project.Current.GetRealOrVirtualDocument(statement.Document.Name, false));
                }
        ...
        protected override void OnParentChanged(EventArgs e)
        {
            ...
            {
                FieldsPalette.Palette.ConditionsForms = new FunctionFormCollection(comboBoxRecordForm.SelectedItem as IForm);
            }
            else
            {
                FieldsPalette.Palette.ClearConditionsForms();
        ...
        private void buttonAddModifyDoc_Click(object sender, EventArgs e)
        {
            RememberAction();
        ...
        private void buttonAddModifyForm_Click(object sender, EventArgs e)
        {
            RememberAction();
        ...
        {
            var form = comboBoxRecordForm.SelectedItem as Form;
            FieldsPalette.Palette.ConditionsForms = form != null ? new FunctionFormCollection(form) : FunctionFormCollection.NULL;
        }
