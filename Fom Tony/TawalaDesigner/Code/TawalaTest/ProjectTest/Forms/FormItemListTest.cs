...
{
	/// <summary>
	/// FormItemListTest comment would go here if I chose to write one
	/// Why can't .NET write an intelligent one for me?
	/// </summary>
	[TestFixture]
	public class FormItemListTest
	{
		...
		public void GetXml() 
		{
			...
			string expString =
                ...
                "<blank label=\"a\" length=\"5\" required=\"false\"></blank>" +
				"</paragraph>" +
				"</fib>\r\n" +
				...
				"Fib item 2: " +
				XmlConstants.EndFont +
                "<blank label=\"a\" length=\"2\" required=\"true\"></blank>" +
				"</paragraph>" +
				"</fib>\r\n" +
				"</items>\r\n";
