...
namespace TawalaTest.ProjectTest
{
	...
	public class FormListTest
	{
		...
		{ 
			Form fc1 = new Form("Form1");
			Form fc2 = new Form("Form2");
		...
		{ 
			Form fc1 = new Form("name 1");
			Form fc2 = new Form("name 2");
		...
		{ 
			Form fc1 = new Form("Form One");
			Form fc2 = new Form("Form Two");
			...
			//Assertions 
			Assert.AreEqual(null, fc1.ConnectedPostProcess);
            Assert.AreEqual("Connected Process", fc2.ConnectedPostProcess.Name);
			...
			//Assertions 
            Assert.AreEqual(null, fc1.ConnectedPostProcess);
            Assert.AreEqual(null, fc2.ConnectedPostProcess);
		}
		...
		{ 
			...
			//Assertions 
            Assert.AreEqual("Connected Process", fc1.ConnectedPostProcess.Name);
            Assert.AreEqual("Connected Process", fc2.ConnectedPostProcess.Name);
		...
		{ 
			...
			Form fc1 = new Form("Form 1");
			fc1.ItemList.Add(item1);
			fc1.ItemList.Add(item2);

			Form fc2 = new Form("Form 2");
			...
			string expString =
				...
				"</items>\r\n" +
				"</form>\r\n" +
                "<form name=\"Form 2\" startPoint=\"false\" themePath=\"default\" blockBackButton=\"false\">\r\n" +
				"</form>\r\n" +
				"</forms>\r\n";
			...
			string expStringWithProcess =
				...
				"</items>\r\n" +
				"</form>\r\n" +
                "<form name=\"Form 2\" startPoint=\"false\" themePath=\"default\" process=\"Connected Process\" blockBackButton=\"false\">\r\n" +
				"</form>\r\n" +
				"</forms>\r\n";
