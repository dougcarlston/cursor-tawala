...
{
	/// <summary>
	/// Test class for the SendStatement class
	/// </summary>
	[TestFixture]
...
#region ObsoleteTests
		...
		public void GetSendInvitationXml()
		{
			...
			statement.AddressTo.Text = "doug@carlston.net";
			statement.Subject = "Testing the Send command";
			statement.SendBody = new SendInvitationBody(new Form("Test Form"), "Hi Doug, can you read this?");
		...
		public void GetSendForeignInvitationXml()
		{
			...
			statement.AddressTo.Text = "doug@carlston.net";
			statement.Subject = "Testing the Send command";
			statement.SendBody = new SendForeignInvitationBody(new Form("Test Form"), "Foreign Project", "Hi Doug, can you read this?");
