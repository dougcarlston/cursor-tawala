...
namespace TawalaTest.ProjectTest
{
	...
	public class ProjectEventsTest 
	{
		...
		{ 
			...
			Document doc1 = new Document("MyDocument 1");
		...
		{ 
			// attach one event handler to "form added" event
        ...
        public void FormRemovingEvent()
        {
            ...
            Form form11 = new Form("Cancel Me");
...
//			Assert.AreEqual(Project.Resources.GetString("FibItemDefaultRTF"), item.Rtf);
		...
		{ 
			...
			ProcessStatement st1 = new ShowDocumentStatement(new Document("New Document X"));
		...
		{ 
			...
			ProcessStatement st1 = new ShowDocumentStatement(new Document("Document Y"));
			Process proc = new Process("Test Process");
		...
		{ 
			...
			ProcessStatement st1 = new ShowDocumentStatement(new Document("Document Z"));
			Process proc = new Process("Test Process");
