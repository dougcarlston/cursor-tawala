...
{
    [TestFixture]
    public class DesignerCanApplyConditionsToFunctions2022 : FunctionTest
    {
        ...
        private IFunction createRecordCountFunctionWithConditions()
        {
            ...
            var recordField = new RecordField(new Record("Record"), ((FibItem)form2.ItemList[0]).BlankList[0]);
            ...
            instance["conditions"] = functionConditions;
        ...
        public void AddingConditionToFunctionProducesExpectedDisplayString()
        {
            ...
            const string expectedString = "<<FORM RECORD COUNT(Form 2, Record:Form 2:Q1:a equals \"foo\")>>";
        ...
        public void AddingConditionToFunctionProducesPersistenceXmlWithConditions()
        {
            ...
            const string expectedXml =
                "<record-count version=\"3\">" + "<form-name>Form 2</form-name>" + "<conditions>" + "<form name=\"Form 2\" />" +
                "<conditions>" + NEWLINE + "<equals field=\"Record:Form 2:Q1:a\">" + NEWLINE + "<string value=\"foo\"/>" + NEWLINE +
                "</equals>" + NEWLINE + "</conditions>" + "</conditions>" + "</record-count>";
        ...
        public void PersistenceXmlWithConditionReferencingFieldProducesPersistenceXmlWithConditionReferencingField()
        {
            const string xmlString =
                "<record-count version=\"3\">" + "<form-name>Form 2</form-name>" + "<conditions>" + "<form name=\"Form 2\" />" +
                "<conditions>" + NEWLINE + "<equals field=\"Record:Form 2:Q1:a\">" + NEWLINE + "<string field=\"Form 2:Q1:a\"/>" + NEWLINE +
                "</equals>" + NEWLINE + "</conditions>" + "</conditions>" + "</record-count>";
        ...
        public void PersistenceXmlWithMultipleConditionsProducesPersistenceXmlWithMultipleConditions()
        {
            const string xmlString =
                "<record-count version=\"3\">" + "<form-name>Form 2</form-name>" + "<conditions>" + "<form name=\"Form 2\" />" +
                "<conditions>" + NEWLINE + "<or>" + NEWLINE + "<equals field=\"Record:Form 2:Q1:a\">" + NEWLINE + "<string value=\"foo\"/>" +
                NEWLINE + "</equals>" + NEWLINE + "<equals field=\"Record:Form 2:Q1:a\">" + NEWLINE + "<string value=\"bar\"/>" + NEWLINE +
                "</equals>" + NEWLINE + "</or>" + NEWLINE + "</conditions>" + "</conditions>" + "</record-count>";
        ...
        public void PersistenceXmlWithSingleConditionProducesValidConditionInFunction()
        {
            ...
            var functionConditions = function.Info.Parameters[1].GetValue(function) as FunctionFilterConditions;
            ...
            Assert.IsInstanceOfType(typeof(Blank), recordField.ReferenceField);
        }
        ...
        public void XmlConditionsParameterResultsInConditionsProperty()
        {
            ...
            Assert.AreEqual(parameterInfo.PropertyType, typeof(FunctionFilterConditions));
            Assert.AreEqual(instance["conditions"].GetType(), typeof(FunctionFilterConditions));
