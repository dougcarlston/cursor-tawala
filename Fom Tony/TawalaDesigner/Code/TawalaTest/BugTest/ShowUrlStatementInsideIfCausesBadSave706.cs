...
{
    [TestFixture]
    public class ShowUrlStatementInsideIfCausesBadSave706
    {
        ...
        public void SaveAndLoad()
        {
            ...
            var showUrlStatement = new ShowUrlStatement("http://www.tawala.com");

            ifStatement.TrueSet.Add(showUrlStatement);
