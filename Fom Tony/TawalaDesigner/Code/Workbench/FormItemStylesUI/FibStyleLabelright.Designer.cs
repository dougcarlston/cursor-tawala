...
{
	partial class FibStyleLabelRight
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.labelFibLabel.Text = "Right-aligned Label:";
			this.labelFibLabel.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// textBox1
			// 
