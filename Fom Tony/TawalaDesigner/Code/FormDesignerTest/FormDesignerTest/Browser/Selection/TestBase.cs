...
namespace TawalaTest.FormDesignerTest.Browser.Selection
{
	public abstract class TestBase
	{
		...
		{
			string rangeAssignmentFormat = @"var range{0} = document.body.createTextRange(); range{0}.findText('{1}'); ";
			string rangeSetEndpointFormat = @"range1.setEndPoint('EndToEnd', range{0}); ";
		...
		private void createViewWithTextItem(XmlElement element)
		{
			...
			browser = TestUtil.PumpMessagesUntilUIReady(View);
		}
