...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
		...
		<div class="sectionContent">
			...
			<div id="snap1" style="margin-top: 1em; ">
				<div style="float: left; width: 510px;">
					<img style="border: 1px solid #dddddd;"src="/images/snapshots/groupquestion-setup-thumb.gif" alt="" />
				</div>
				<div style="font-size: .9em; color: #666666; margin-left: 1em; float: left; width: 135px;">
					This is the setup form for the Poll or Survey project.
				</div>
			</div>
			<div id="snap2" class="" style="clear: both; padding-top: 1em;">
				<div style="font-size: .9em; color: #666666; margin-right: 1em; float: left; width: 135px;">
					Here's an example of what the the Poll or Survey project might look like after the setup.
				</div>
				<div style="float: right; width: 510px;">
					<img style="border: 1px solid #dddddd;"src="/images/snapshots/groupquestion-mainscreen-thumb.gif" alt="" />
				</div>
			</div>
			<div id="snap3" style="clear: both; padding-top: 1em;">
				<div style="float: left; width: 510px;">
					<img style="border: 1px solid #dddddd;"src="/images/snapshots/groupquestion-report-thumb.gif" alt="" />
				</div>
				<div style="font-size: .9em; color: #666666; margin-left: 1em; float: left; width: 135px;">
					Here's the report screen from the Poll or Survey project.
				</div>
			</div>
			<br style="clear:both;" />
	...
	<div id="snapshot1" style="visibility:hidden; cursor: pointer;">
		...
		<div class="bd" style="background-color: #dddddd;">
			<img src="/images/snapshots/groupquestion-setup.gif" />
			<p>
				The setup form from the Group Question project.
			</p>
		</div>
	...
	<div id="snapshot2" style="visibility:hidden; cursor: pointer;">
		<div class="hd"><div class="tl"></div><span></span><div class="tr"></div></div>
		<div class="bd" style="background-color: #dddddd;">
			<img src="/images/snapshots/groupquestion-mainscreen.gif" />
			<p>
				An example of the main screen of the Group Question project after going through setup.
			</p>
		</div>
		<div class="ft">Click image to close window</div>
	</div>
	...
	<div id="snapshot3" style="visibility:hidden; cursor: pointer;">
		<div class="hd"><div class="tl"></div><span></span><div class="tr"></div></div>
		<div class="bd" style="background-color: #dddddd;">
			<img src="/images/snapshots/groupquestion-report.gif" />
			<p>
				An example of the report screen of the Group Question project after going through setup.
			</p>
		</div>
		<div class="ft">Click image to close window</div>
	</div>
