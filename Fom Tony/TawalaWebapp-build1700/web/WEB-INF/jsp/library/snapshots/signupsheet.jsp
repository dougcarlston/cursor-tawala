		...
		<div class="sectionContent">
			...
			<div id="snap1" style="margin-top: 1em;">
				<div style="float: left; width: 510px;">
					<img style="border: 1px solid #dddddd;"src="/images/snapshots/signupsheet-setup-thumb.gif" alt="" />
				</div>
				<div style="font-size: .9em; color: #666666; margin-left: 1em; float: left; width: 135px;">
					This is the  setup screen for the Signup Sheet project.
				</div>
			</div>
			<div id="snap2" class="" style="clear: both; padding-top: 1em;">
				<div style="font-size: .9em; color: #666666; margin-right: 1em; float: left; width: 135px;">
					Here's an example of what the Signup Sheet project might look like after setup.
				</div>
				<div style="float: right; width: 510px;">
					<img style="border: 1px solid #dddddd;"src="/images/snapshots/signupsheet-mainscreen-thumb.gif" alt="" />
				</div>
			</div>
			<div id="snap3" style="clear: both; padding-top: 1em;">
				<div style="float: left; width: 510px;">
					<img style="border: 1px solid #dddddd;"src="/images/snapshots/signupsheet-report-thumb.gif" alt="" />
				</div>
				<div style="font-size: .9em; color: #666666; margin-left: 1em; float: left; width: 135px;">
					Here's the report screen for the Signup Sheet project.
				</div>
			</div>
			<br style="clear:both;" />
...
--%>
	...
	<div id="snapshot1" style="visibility:hidden; cursor: pointer;">
		...
		<div class="bd" style="background-color: #dddddd;">
			<img src="/images/snapshots/signupsheet-setup.gif" />
			<p>
				The setup screen for the Signup Sheet project.
			</p>
		</div>
	...
	<div id="snapshot2" style="visibility:hidden; cursor: pointer;">
		<div class="hd"><div class="tl"></div><span></span><div class="tr"></div></div>
		<div class="bd" style="background-color: #dddddd;">
			<img src="/images/snapshots/signupsheet-mainscreen.gif" />
			<p>
				An example of the main screen of the Signup Sheet project after setup.
			</p>
		</div>
		<div class="ft">Click image to close window</div>
	</div>
	...
	<div id="snapshot3" style="visibility:hidden; cursor: pointer;">
		<div class="hd"><div class="tl"></div><span></span><div class="tr"></div></div>
		<div class="bd" style="background-color: #dddddd;">
			<img src="/images/snapshots/signupsheet-report.gif" />
			<p>
				An example of the report screen of the Signup Sheet project after setup.
			</p>
		</div>
		<div class="ft">Click image to close window</div>
	</div>
