 ...
 *	Tawala.ProjectGroup.COACH_ID
 *	Tawala.ProjectGroup.MEMO
 *	Tawala.ProjectGroup.URL_LoadCoaches
 *	Tawala.ProjectGroup.URL_UpdateCoachStatus
...
Tawala.ProjectGroup.onProjectSelect = function(select) {
	Tawala.ProjectGroup.currentProjectId = select.options[select.selectedIndex].value;
	if(Tawala.ProjectGroup.currentProjectId == '') {
		Tawala.ProjectGroup.clearCoachesSection();
		return;
	}
	
	Tawala.ProjectGroup.loadCoaches(Tawala.ProjectGroup.groupId, Tawala.ProjectGroup.currentProjectId);
};
