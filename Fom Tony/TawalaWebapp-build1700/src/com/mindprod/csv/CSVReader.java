 ...
 *         massage categories for use in case clauses. - faster skipToNextLine
 *         <br>
...
public class CSVReader {
        ...
        default:
            if (c == quote) {
                return QUOTE;
                                         ...
                                         * dynamically determined so can't use
                                         * as case label
                                         */) {
                return SEPARATOR;
            }
     ...
     * @throws IOException
     */
    public List<String> getAllFieldsInLine() throws EOFException, IOException {
